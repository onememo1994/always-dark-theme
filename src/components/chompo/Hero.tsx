    ...
    <section className="relative overflow-hidden bg-signal pb-10">
      ...
      <div className="relative mx-auto mt-6 max-w-[760px] px-4 sm:mt-10">
        ...
        <div className="absolute -bottom-1 left-1/2 -translate-x-1/2">
          <button
            type="button"
            className="rounded-full bg-signal px-6 py-2 font-heavy text-xs tracking-[0.1em] text-cream uppercase transition-transform hover:-translate-y-0.5 sm:px-8 sm:py-2.5 sm:text-sm"
          >
            Find Location
          </button>
        </div>
